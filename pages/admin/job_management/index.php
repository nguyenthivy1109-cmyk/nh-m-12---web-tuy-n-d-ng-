...
require_once __DIR__ . '/../controllers/job_management_logic.php';
?>
...
<head>
    <meta charset="UTF-8">
    <title>Quản lý Tin tuyển dụng - Hệ thống tuyển dụng</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <?php include __DIR__ . '/../views/job_management_content.php'; ?>
    </div>
