...
require_once __DIR__ . '/../controllers/applications_management_logic.php';
?>
...
<head>
    <meta charset="UTF-8">
    <title>Quản lý Hồ sơ ứng tuyển - Hệ thống tuyển dụng</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <?php include __DIR__ . '/../views/applications_management_content.php'; ?>
    </div>
